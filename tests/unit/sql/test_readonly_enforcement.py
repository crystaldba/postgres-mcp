...
async def test_force_readonly_enforcement():
    ...
    with patch("postgres_mcp.utils.sql_driver.current_access_mode", AccessMode.UNRESTRICTED), patch(
        "postgres_mcp.utils.sql_driver.db_connection", mock_conn_pool
    ...
    with patch("postgres_mcp.utils.sql_driver.current_access_mode", AccessMode.RESTRICTED), patch(
        "postgres_mcp.utils.sql_driver.db_connection", mock_conn_pool
    ), patch.object(SqlDriver, "_execute_with_connection", mock_execute):
        driver = await get_sql_driver()
